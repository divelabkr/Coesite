# Sync note: This root file is a Codex-compatible copy of docs/01-CLAUDE.md. Update docs/01-CLAUDE.md first, then resync this copy.
# AGENTS.md — Coesite MVP P0 프로젝트 헌법
**DiveLab AI Trust Security Protocol · Codex 작업 절대 규칙**

> 파일명 `AGENTS.md`는 Codex 호환을 위해 유지한다. 원본 정책은 `docs/01-CLAUDE.md`와 동기화한다.
